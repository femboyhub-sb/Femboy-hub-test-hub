...
if placeId == 18550498098 then
    local Window = Rayfield:CreateWindow({
        Name = "Femboy Hub - Avatar & Relude",
        LoadingTitle = "Femboy Hub",
        LoadingSubtitle = "by silentabsolutedayn",
        ConfigurationSaving = { Enabled = false }
    })

    local Tab = Window:CreateTab("Avatar & Relude", 4483345998)
    ...
    Tab:CreateButton({
        ...
        Callback = function()
            local function spamDoors()
                ...
                while true do
                    -- 1. РђРєС‚РёРІР°С†РёСЏ РІСЃРµС… ProximityPrompt
                    ...
                    -- 2. РљР»РёРєРµСЂС‹ Рё РїСЂСЏРјС‹Рµ РєР»РёРєРё РїРѕ Hitbox / ClickDetector
...
elseif placeId == 93981091811742 then
    ...
    Tab1:CreateButton({
        Name = "Auto-Get avatar+relude",
        Callback = function()
            TeleportService:Teleport(18550498098, lp)
        end
    })
